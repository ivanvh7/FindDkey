...
$sql = "SELECT * FROM keycaps WHERE 1=1";
$params = [];
$types = "";
...
<main style="margin-top:60px;">
    <h1 style="text-align:left;">Keycaps</h1>
  <nav class="breadcrumb">
    <a href="index.php">Home</a> / <span>Keycaps</span>
  </nav>

  <form method="get" action="keycaps.php" class="filtro-form">
    <label for="material">Material:</label>
    <select name="material" id="material">
      <option value="">Todos</option>
      <option value="ABS" <?php if ($material == 'ABS') echo 'selected'; ?>>ABS Keycaps</option>
      <option value="PBT" <?php if ($material == 'PBT') echo 'selected'; ?>>PBT Keycaps</option>
    </select>

    <label for="marca">Marca:</label>
    <select name="marca" id="marca">
      <option value="">Todas</option>
      <option value="GMK" <?php if ($marca == 'GMK') echo 'selected'; ?>>GMK</option>
      <option value="Pbtfans" <?php if ($marca == 'Pbtfans') echo 'selected'; ?>>Pbtfans</option>
      <option value="Signature Plastics" <?php if ($marca == 'Signature Plastics') echo 'selected'; ?>>Signature Plastics</option>
    </select>
  </form>

<div class="products">
  <?php while ($row = $result->fetch_assoc()): ?>
    <a href="detalle_producto.php?tabla=keycaps&id=<?php echo urlencode($row['id']); ?>" class="product-card" style="text-decoration: none; color: inherit;">
